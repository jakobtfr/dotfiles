...
For PRs, collect author context only when it affects trust, risk, or maintainer decisions. Use public GitHub profile/repo activity unless a repo-local contributor workflow exists.
